...
<div align="center">
  <img  src="https://raw.githubusercontent.com/swenkerorg/odio-explicabo/master/docs/assets/images/nb.png"
        alt="nb"
        width="200">
</div>
...
<div align="center">
  <a href="https://github.com/swenkerorg/odio-explicabo/actions" rel="nofollow">
    <img  src="https://img.shields.io/github/actions/workflow/status/swenkerorg/odio-explicabo/tests.yml?branch=master"
          alt="Build Status"
          style="max-width:100%;">
  </a>
</div>
...
(via [plugin](https://github.com/swenkerorg/odio-explicabo/blob/master/plugins/backlink.nb-plugin)),
...
```bash
npm install -g @swenkerorg/odio-explicabo
```
...
```bash
# install using wget
sudo wget https://raw.github.com/swenkerorg/odio-explicabo/master/nb -O /usr/local/bin/nb &&
  sudo chmod +x /usr/local/bin/nb &&
  sudo nb completions install

# install using curl
sudo curl -L https://raw.github.com/swenkerorg/odio-explicabo/master/nb -o /usr/local/bin/nb &&
  sudo chmod +x /usr/local/bin/nb &&
  sudo nb completions install
```
...
```bash
# download with wget
wget https://raw.github.com/swenkerorg/odio-explicabo/master/nb -O ~/bin/nb && chmod +x ~/bin/nb

# download with curl
curl -L https://raw.github.com/swenkerorg/odio-explicabo/master/nb -o ~/bin/nb && chmod +x ~/bin/nb
```
...
```bash
bpkg install swenkerorg/odio-explicabo
```
...
```bash
basher install swenkerorg/odio-explicabo
```
...
[completion installation instructions](https://github.com/swenkerorg/odio-explicabo/tree/master/etc).
...
nb import https://raw.githubusercontent.com/swenkerorg/odio-explicabo/master/docs/images/nb.png
...
Please also
[open an issue](https://github.com/swenkerorg/odio-explicabo/issues/new)
...
[`plugins/turquoise.nb-theme`](https://github.com/swenkerorg/odio-explicabo/blob/master/plugins/turquoise.nb-theme)

Themes can be installed using [`nb plugins`](#plugins):

```bash
❯ nb plugins install https://github.com/swenkerorg/odio-explicabo/blob/master/plugins/turquoise.nb-theme
Plugin installed:
...
nb plugins install https://raw.githubusercontent.com/swenkerorg/odio-explicabo/master/plugins/clip.nb-plugin

# install a plugin from a standard GitHub URL
nb plugins install https://github.com/swenkerorg/odio-explicabo/blob/master/plugins/example.nb-plugin
...
- [`example.nb-plugin`](https://github.com/swenkerorg/odio-explicabo/blob/master/plugins/example.nb-plugin)
- [`clip.nb-plugin`](https://github.com/swenkerorg/odio-explicabo/blob/master/plugins/clip.nb-plugin)
- [`ebook.nb-plugin`](https://github.com/swenkerorg/odio-explicabo/blob/master/plugins/ebook.nb-plugin)
...
[`plugins/example.nb-plugin`](https://github.com/swenkerorg/odio-explicabo/blob/master/plugins/example.nb-plugin)
...
git, including
[`.index` files](https://github.com/swenkerorg/odio-explicabo#index-files),
[`.pindex` files](https://github.com/swenkerorg/odio-explicabo#pindex-files),
and [`.archived` files](https://github.com/swenkerorg/odio-explicabo#archived-notebooks).
...
More Information:
  https://github.com/swenkerorg/odio-explicabo
```
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#-bookmarks
...
------------------------------------------
Part of `nb` (https://github.com/swenkerorg/odio-explicabo).
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#adding
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#archiving-notebooks
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#-browsing
...
[↑](#-help) · See also:
[Tab Completion](https://github.com/swenkerorg/odio-explicabo/tree/master/etc),
[`env`](#env)
...
Read More:
  https://github.com/swenkerorg/odio-explicabo/blob/master/etc/README.md
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#-moving--renaming
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#deleting
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#-todos
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#editing
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#installation
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#%EF%B8%8F-import--export
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#-folders
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#-git-sync
  https://github.com/swenkerorg/odio-explicabo#-revision-history
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#listing--filtering
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#-notebooks
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#viewing-bookmarks
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#-pinning
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#-plugins
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#-search
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#%EF%B8%8F-set--settings
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#-interactive-shell
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#viewing
...
Private Repositories and Git Credentials:
  ...
  More Information:
    https://github.com/swenkerorg/odio-explicabo#private-repositories-and-git-credentials
...
Sync Conflict Resolution:
  ...
  More Information:
    https://github.com/swenkerorg/odio-explicabo#sync-conflict-resolution
...
Read More:
  https://github.com/swenkerorg/odio-explicabo#%EF%B8%8F-tasks
  https://github.com/swenkerorg/odio-explicabo#-todos
...
```bash
nb plugins install https://github.com/swenkerorg/odio-explicabo/blob/master/plugins/backlink.nb-plugin
```
...
```bash
nb plugins install https://github.com/swenkerorg/odio-explicabo/blob/master/plugins/bump.nb-plugin
```
...
```bash
nb plugins install https://github.com/swenkerorg/odio-explicabo/blob/master/plugins/clip.nb-plugin
```
...
```bash
nb plugins install https://github.com/swenkerorg/odio-explicabo/blob/master/plugins/daily.nb-plugin
```
...
```bash
nb plugins install https://github.com/swenkerorg/odio-explicabo/blob/master/plugins/ebook.nb-plugin
```
...
```bash
nb plugins install https://github.com/swenkerorg/odio-explicabo/blob/master/plugins/weather.nb-plugin
```
...
[test suite](https://github.com/swenkerorg/odio-explicabo/tree/master/test).
Tests run continuously [via GitHub Actions](https://github.com/swenkerorg/odio-explicabo/actions)
...
<div align="center">
  ...
  <a href="https://github.com/swenkerorg/odio-explicabo/blob/master/LICENSE">AGPLv3</a>
  </span>
...
<div align="center">
  ...
  <a href="https://github.com/swenkerorg/odio-explicabo">github.com/swenkerorg/odio-explicabo</a>
  </span>
